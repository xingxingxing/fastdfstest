...
public class FastClientPoolConfig extends GenericObjectPoolConfig {

    /**
     * 从池中借出的对象的最大数目
     */
    public static final int FDFS_MAX_TOTAL = 5;
     ...
     */
    public static final long FDFS_MAX_WAIT_MILLIS = 1500;
